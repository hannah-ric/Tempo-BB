export interface FurnitureDesignBrief {
  ...
  material?: string;
  // Add other relevant fields based on user input capabilities
}
...
export interface HardwareModel extends MaterialModel { // Hardware can share some properties with MaterialModel
...
export interface BuildPlan {
  ...
  supplierQuotes?: Array<{ supplierId: string, quoteId: string, totalCost: number, leadTime: string }>;
} 